...
class UsersController extends Controller
{
    ...
    public function user_save(Request $request)
    {
        ...
        DB::commit();
        return redirect()->to('/backend/users/user-create')->with('message','Editor Account create successfully!');
    ...
    public function user_edit($uuid)
    {
        ...
        return redirect()->to('/backend/users/user-list')->with('error', 'Record Not Found!');
    }
    ...
    public function user_update(Request $request)
    {
        ...
        if($validator->fails())
        {
            return redirect()->to('/backend/users/user-edit/'  . $request->id)->with('error', 'All Fields are required!');
        }
