    ...
    <div class="col-lg-10 offset-1">
      <div class="card">
        <div class="card-body">
          ...
          <form class="row g-2 needs-validation" novalidate method="POST" action="{{ url('/backend/tasks/task-edit') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-md-6 position-relative">
              ...
              {{ in_array($record->status, ['COMPLETED']) ? 'disabled' : '' }}
              >
            </div>
            ...
            <div class="col-md-6 position-relative">
              ...
              >
                ...
                <option value="{{ $key }}" {{ $record->approval_status == $key ? 'selected' : '' }}>{{ $label }}</option>
                @endforeach
              </select>
            </div>
              ...
              <div id="spare-parts-wrapper">
                ...
                <div class="row mb-3 spare-part-item">
                  ...
                  <div class="col-md-1">
                    ...
                    <i class="bi bi-x-circle remove-spare-part"></i>
                    </span>
                  </div>
                  @endif
