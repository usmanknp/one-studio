            ...
            <div class="card">
                <div class="card-body table-responsive" >
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ url('/backend/tasks/create-task') }}" class="btn btn-primary btn-sm">Add New</a>
                    </div>
                    ...
                    <table class="table  table-bordered text-center" style="font-size:12px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a  href="{{ url('/backend/tasks/task-edit', $record->uuid) }}">{{ $record->track_id}}</a>
                                </td>
                                <td>
                                    <a  href="{{ url('/backend/tasks/task-edit', $record->uuid) }}">{{ $record->title}}</a>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="filter">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                            <li>
                                                <a class="dropdown-item" href="{{ url('/backend/tasks/task-edit', $record->uuid) }}">
                                                    Edit
                                                </a>
                                            </li>
                                            @if($record->file != null)
